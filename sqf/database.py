...
EXPRESSIONS = [
    ...
    BinaryExpression(Group, Keyword('create3DENEntity'), Array, Nothing),
    ...
    BinaryExpression(Object, Keyword('createTask'), Array, Task),
    ...
    BinaryExpression(Control, Keyword('deleteEditorObject'), String, Nothing),
    ...
    BinaryExpression(Control, Keyword('drawLocation'), Object, Nothing),
    BinaryExpression(Control, Keyword('drawPolygon'), Array, Nothing),
    BinaryExpression(Control, Keyword('drawRectangle'), Array, Nothing),
    BinaryExpression(Control, Keyword('editObject'), String, Nothing),
    ...
    BinaryExpression(Control, Keyword('evalObjectArgument'), Array, Nothing),
    BinaryExpression(Type, Keyword('exec'), String, Nothing),
    BinaryExpression(Control, Keyword('execEditorScript'), Array, Nothing),
    ...
    BinaryExpression(Display, Keyword('getVariable'), String, Nothing),
    BinaryExpression(Display, Keyword('getVariable'), Array, Nothing),
    BinaryExpression(Control, Keyword('getVariable'), String, Nothing),
    BinaryExpression(Control, Keyword('getVariable'), Array, Nothing),
    BinaryExpression(Object, Keyword('getVariable'), String, Nothing),
    BinaryExpression(Object, Keyword('getVariable'), Array, Nothing),
    BinaryExpression(Group, Keyword('getVariable'), String, Nothing),
    BinaryExpression(Group, Keyword('getVariable'), Array, Nothing),
    ...
    BinaryExpression(Object, Keyword('getVariable'), String, Nothing),
    BinaryExpression(Object, Keyword('getVariable'), Array, Nothing),
    BinaryExpression(Task, Keyword('getVariable'), String, Nothing),
    BinaryExpression(Task, Keyword('getVariable'), Array, Nothing),
    BinaryExpression(Object, Keyword('getVariable'), String, Nothing),
    BinaryExpression(Object, Keyword('getVariable'), Array, Nothing),
    ...
    BinaryExpression(Control, Keyword('onDoubleClick'), String, Nothing),
    BinaryExpression(Type, Keyword('onMapSingleClick'), Code, Nothing),
    BinaryExpression(Type, Keyword('onMapSingleClick'), String, Nothing),
    BinaryExpression(Control, Keyword('onShowNewObject'), String, Nothing),
    ...
    BinaryExpression(Control, Keyword('selectEditorObject'), String, Nothing),
    ...
    BinaryExpression(Object, Keyword('sendTask'), Array, Task),
    ...
    BinaryExpression(Control, Keyword('setObjectArguments'), Array, Nothing),
    ...
    BinaryExpression(Control, Keyword('setObjectProxy'), Array, Nothing),
    ...
    BinaryExpression(Object, Keyword('setSide'), Side, Nothing),
    ...
    BinaryExpression(Control, Keyword('showNewEditorObject'), Array, Nothing),
